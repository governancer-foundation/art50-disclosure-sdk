...
# Contributing to `@governancer-foundation/art50-disclosure-sdk`
...
```sh
git clone https://github.com/governancer-foundation/art50-disclosure-sdk.git
cd art50-disclosure-sdk
