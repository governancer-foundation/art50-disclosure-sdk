...
This document describes how the `governancer-foundation/art50-disclosure-sdk` project
...
- Releases are tagged in git, published to GitHub Releases, and (when the package
  is marked publishable) pushed to npm as `@governancer-foundation/art50-disclosure-sdk` with npm
  provenance.
...
<https://github.com/governancer-foundation/art50-disclosure-sdk/commits/main>.

## Updates

| Version | Date | Author | Change |
|---|---|---|---|
| v0.1 | 2026-06-17 | Alexander Brichkin | Initial governance document (adapted from ariada/ADOPTA for the single-package `@governancer-foundation/art50-disclosure-sdk`). |
